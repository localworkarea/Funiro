(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-main__slider")) new core(".slider-main__slider", {
            ...
            navigation: {
                prevEl: ".slider-main__slider-arrows .swiper-button-prev",
                nextEl: ".slider-main__slider-arrows .swiper-button-next"
            },
            on: {}
        });
        if (document.querySelector(".slider-rooms")) new core(".slider-rooms", {
            ...
            navigation: {
                nextEl: ".slider-arrows .swiper-button-prev",
                prevEl: ".slider-arrows .swiper-button-next"
            }
        });
        if (document.querySelector(".slider-tips")) new core(".slider-tips", {
            ...
            navigation: {
                nextEl: ".slider-tips__arrows .swiper-button-prev",
                prevEl: ".slider-tips__arrows .swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (window.innerWidth > 768 && isMobile.any()) {
                ...
                if (!targetElement.closest(".menu__item") && document.querySelectorAll(".menu__item._hover").length > 0) document.querySelector(".menu__item._hover").classList.remove("_hover");
            }
